        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 overflow-hidden bg-white shadow dark:bg-gray-800 sm:rounded-lg">
                ...
                <form method="post" action="{{ route('fileImport') }}" enctype="multipart/form-data">
                    ...
                    <button type="submit"
                        class="px-3 py-2 ml-5 text-sm font-medium leading-4 text-gray-100 bg-indigo-600 border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Upload
                    </button>
                </form>
            </div>
